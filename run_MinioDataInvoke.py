...
if __name__ == '__main__':
    ...
    argParser.add_argument("--host", default="127.0.0.1", type=str, help="本服务IP地址，缺省 127.0.0.1", dest="host")
    argParser.add_argument("--port", default=8120, type=int, help="本服务端口号，缺省 8120", dest="port")
    argParser.add_argument("--miniohost", default="127.0.0.1", type=str, help="minio服务IP地址，缺省 127.0.0.1", dest="miniohost")
    argParser.add_argument("--minioport", default=9000, type=int, help="minio服务端口号，缺省 9000", dest="minioport")
    argParser.add_argument("--miniouser", default="minioadmin", type=str, help="minio用户名，缺省 minioadmin", dest="miniouser")
    argParser.add_argument("--miniopwd", default="minioadmin", type=str, help="minio密码，缺省 minioadmin", dest="miniopwd")
